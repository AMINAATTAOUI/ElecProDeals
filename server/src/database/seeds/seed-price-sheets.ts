  ...
  const sheets: Array<{
  ...
  }> = [
    {
      ...
      rule: {
        operator: 'multiply',
        value: 1.0,
        description: 'À configurer — tarif artisan (×1.0 = prix public)',
      },
    },
    {
      ...
      rule: {
        ...
        value: 1.0,
        description:
          'À configurer — tarif gros installateur (×1.0 = prix public)',
      },
    },
    {
      name: 'Grossistes',
      ...
      rule: {
        operator: 'multiply',
        value: 1.0,
        description: 'À configurer — tarif grossiste (×1.0 = prix public)',
      },
    },
  ];
